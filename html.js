const file_html_data =  "<div class=\"mdc-card\"\n" +
                        ...
                        "    <img class=\"mdc-card__media mdc-card__media--16-9\" src=\"/getVideoPreview?res=mime-type-icon/{1}&path={2}\" style=\"width: 100%;\" alt=\"cover\"/>\n" +
                        "    <ul class=\"mdc-list\">\n" +
                        ...
                        "    </div>\n" +
                        "</div>";
const directory_html_data = "<div>\n" +
                            "   <div class=\"mdc-card\" style=\"height: fit-content;cursor: pointer;\" onclick=\"onItemClick('{0}','Directory')\">\n" +
                            "       <img class=\"mdc-card__media\" src=\"/getCover?cover={0}\" style=\"width: 100%;\" alt=\"{0}\"/>\n" +
                            "   </div>\n" +
                            "   <div style=\"padding-left: 7px;padding-top: 10px;font-size: 23px;\">{1}</div>\n" +
                            "</div>";
